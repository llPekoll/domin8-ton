...
export function dictValueParserDomin8$Data(): DictionaryValue<Domin8$Data> {
 ...
 type Domin8Lobby_init_args = {
    $$type: 'Domin8Lobby_init_args';
    parent: Address;
    lobbyId: bigint;
}

function initDomin8Lobby_init_args(src: Domin8Lobby_init_args) {
    return (builder: Builder) => {
        const b_0 = builder;
        b_0.storeAddress(src.parent);
        b_0.storeInt(src.lobbyId, 257);
    };
}

async function Domin8Lobby_init(parent: Address, lobbyId: bigint) {
    const __code = Cell.fromHex('');
    const builder = beginCell();
    builder.storeUint(0, 1);
    initDomin8Lobby_init_args({ $$type: 'Domin8Lobby_init_args', parent, lobbyId })(builder);
    const __data = builder.endCell();
    return { code: __code, data: __data };
}

export const Domin8Lobby_errors = {
...
export const Domin8Lobby_errors_backward = {
    "Stack underflow": 2,
    "Stack overflow": 3,
    "Integer overflow": 4,
...
const Domin8Lobby_types: ABIType[] = [
...
const Domin8Lobby_getters: ABIGetter[] = [
    {"name":"state","methodId":77589,"arguments":[],"returnType":{"kind":"simple","type":"LobbyState","optional":false}},
]

export const Domin8Lobby_getterMapping: { [key: string]: string } = {
    'state': 'getState',
}

const Domin8Lobby_receivers: ABIReceiver[] = [
    {"receiver":"internal","message":{"kind":"typed","type":"SetLobbyConfig"}},
    {"receiver":"internal","message":{"kind":"typed","type":"JoinLobby"}},
...
export class Domin8Lobby implements Contract {
    
    public static readonly storageReserve = 0n;
    public static readonly errors = Domin8Lobby_errors_backward;
    public static readonly opcodes = Domin8Lobby_opcodes;
    
    static async init(parent: Address, lobbyId: bigint) {
        return await Domin8Lobby_init(parent, lobbyId);
    }
    
    static async fromInit(parent: Address, lobbyId: bigint) {
        const __gen_init = await Domin8Lobby_init(parent, lobbyId);
        const address = contractAddress(0, __gen_init);
        return new Domin8Lobby(address, __gen_init);
    }
    
    static fromAddress(address: Address) {
        return new Domin8Lobby(address);
    }
    
    readonly address: Address; 
    readonly init?: { code: Cell, data: Cell };
    readonly abi: ContractABI = {
        types:  Domin8Lobby_types,
        getters: Domin8Lobby_getters,
        receivers: Domin8Lobby_receivers,
        errors: Domin8Lobby_errors,
    };
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: SetLobbyConfig | JoinLobby | SettleLobby | RescueLobby | Deploy) {
        
        let body: Cell | null = null;
        if (message && typeof message === 'object' && !(message instanceof Slice) && message.$$type === 'SetLobbyConfig') {
            body = beginCell().store(storeSetLobbyConfig(message)).endCell();
        }
        if (message && typeof message === 'object' && !(message instanceof Slice) && message.$$type === 'JoinLobby') {
            body = beginCell().store(storeJoinLobby(message)).endCell();
        }
    ...
    async getState(provider: ContractProvider) {
        ...
        const result = loadGetterTupleLobbyState(source);
        return result;
    }
